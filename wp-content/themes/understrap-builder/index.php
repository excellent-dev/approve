...
<div class="wrapper" id="index-wrapper">
  ...
  <div class="<?php echo esc_attr( $understrap_builder_container_type ); ?>" id="content" tabindex="-1">
    ...
    <div class="row">
          ...
          <div class="col-12">
            ...
            <main class="site-main" id="main">
              ...
              <div class="row">
                 ...
                 */
                $immovable = new WP_Query(array('post_type' => 'immovable', 'posts_per_page' => -1 ));
                ?>
                <?php if ( $immovable->have_posts() ) : ?>
                  ...
                  <?php while ( $immovable->have_posts() ) : $immovable->the_post(); ?>

                    <?php get_template_part( 'loop-templates/content', get_post_format() ); ?>
                    
                    <span style="padding-left: 15px;" >Общая площадь составляет <?php the_field('area') ?> м<sup>2</sup>, из которых <?php the_field('living_area') ?> м<sup>2</sup> - жилая площадь.<br>Недвижимость находится по адресу <?php the_field('address') ?>, <?php the_field('floor') ?> этаж.<br>Стоимость сосавляет: <?php the_field('price') ?> рублей.</span>
      ...
      <?php echo do_shortcode( '[public-form post_type="immovable"]' ); ?>
    </div><!-- .row -->
